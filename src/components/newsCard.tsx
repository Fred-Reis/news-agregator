...
export const Card = ({ news }: { news: Article }) => (
  <div
    key={news.id}
  ...
  >
    ...
    <div className="p-2 sm:p-4 flex-1 h-full flex flex-col">
      <div className="flex flex-row md:flex-col items-center md:items-start gap-16 md:gap-0">
        <span className="text-gray-500 text-[10px] sm:mt-2 font-bold">
      ...
      <h3 className="text-gray-700 text-md sm:text-lg mt-1 sm:mt-2">
        {news.title}
      </h3>

      <p className="text-gray-500 text-xs my-1 sm:my-4 overflow-hidden text-ellipsis max-h-20">
